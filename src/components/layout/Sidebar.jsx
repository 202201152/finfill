...
export default function Sidebar() {
  return (
    <>
      ...
      <aside className="hidden xl:flex flex-col items-center w-16 bg-white border-r border-[var(--color-border-color)] py-8 z-10">
      ...
      <nav className="xl:hidden fixed bottom-0 left-0 right-0 h-16 bg-white border-t border-[var(--color-border-color)] flex justify-space-around items-center px-6 z-50 shadow-[0_-2px_10px_rgba(0,0,0,0.05)]">
